    ...
    <div x-cloak
        ...
        <div class="p-6">
            <div class="flex items-center space-x-3">
                ...
                <h2 x-show="sidebarOpen" class="text-xl font-bold font-['Poppins'] text-white transition-opacity">User Panel</h2>
            </div>
        ...
        <nav class="mt-6 px-4 flex-1">
            <div class="space-y-1">
                <a href="{{ route('user.dashboard') }}"
                    class="flex items-center py-3 px-4 rounded-lg mb-2 transition-all duration-200 {{ request()->routeIs('user.dashboard') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-gray-300 hover:bg-gray-800/50' }}">
                ...
                <a href="{{ route('user.books.index') }}"
                    class="flex items-center py-3 px-4 rounded-lg mb-2 transition-all duration-200 {{ request()->routeIs('user.books.*') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-gray-300 hover:bg-gray-800/50' }}">
                    <i class="ph-books-bold text-xl" :class="{'mr-3': sidebarOpen}"></i>
                    <span x-show="sidebarOpen" class="transition-opacity">Browse Books</span>
                </a>

                <a href="{{ route('user.borrows') }}"
                    class="flex items-center py-3 px-4 rounded-lg mb-2 transition-all duration-200 {{ request()->routeIs('user.borrows') ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-gray-300 hover:bg-gray-800/50' }}">
                    <i class="ph-bookmark-bold text-xl" :class="{'mr-3': sidebarOpen}"></i>
                    <span x-show="sidebarOpen" class="transition-opacity">My Borrows</span>
                    @php
